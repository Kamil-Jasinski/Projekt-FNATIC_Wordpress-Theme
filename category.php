...
<p class="show-by-category"><i class="fas fa-archive"></i> Show posts by category: <?php echo single_cat_title(); ?></p>

<!-- TEN PLIK WYŚWIETLA STRONĘ KATEGORII-->
        <?php
            if (have_posts()) :
      ...
      <div class="event-general-info"> <!-- Included information about date and location -->
        ...
        <div class="event-info"> <!-- Included event title & article -->
            ...
            <article class="content-text">
                <?php the_content();?>
                <a href="<?php the_permalink();?>#post" class="btn-default">Read Moree</a>
            </article>
