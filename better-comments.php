		...
		<?php } ?>
			...
			<div class="user-card">
				...
				if ( $args['avatar_size'] != 0 ) {
					$avatar_size = ! empty( $args['avatar_size'] ) ? $args['90'] : 70; // set default avatar size
						echo get_avatar( $comment, $avatar_size );
				}
				// Display author name
				printf( __( '<p class="fn"><span class="comment-author-link">%s</span></p>', 'textdomain' ), get_comment_author_link() ); ?>
...
<!--
comment_reply_link był tutaj
-->
				
				<div class="comment-meta commentmetadata">
					<a class="comment-metadata" href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ); ?>"><?php
